...
## lint-update: Update golangci-lint and govulncheck to latest versions
lint-update:
	@echo "Updating tools..."
	...
	@echo "Updated $$(go tool -modfile=tools.mod golangci-lint version)"

## vuln-check: Check for known vulnerabilities using pinned govulncheck
vuln-check:
